...
public class RegisterWindow extends JFrame {
	...
	public RegisterWindow() {
		...
		/*
		 * JComboBox stateBox = new JComboBox(); stateBox.setBounds(180, 108, 80, 27);
		 * stateBox.setModel(new DefaultComboBoxModel(new String[] {"AK", "AL", "AR",
		 * "AS", "AZ", "CA", "CO", "CT", "DC", "DE", "FL", "GA", "GU", "HI", "IA", "ID",
		 * "IL", "IN", "KS", "KY", "LA", "MA", "MD", "ME", "MI", "MN", "MO", "MP", "MS",
		 * "MT", "NC", "ND", "NE", "NH", "NJ", "NM", "NV", "NY", "OH", "OK", "OR", "PA",
		 * "PR", "RI", "SC", "SD", "TN", "TX", "UM", "UT", "VA", "VI", "VT", "WA", "WI",
		 * "WV", "WY"})); stateBox.setMaximumRowCount(50); contentPane.add(stateBox);
		 */
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					PreparedStatement ps = conn.prepareStatement(
							"INSERT INTO RegisterCustomer (SSN, Username, Password, First_Name, Last_Name, Email, Street_Address, City, State, Zipcode, Security_Question, Security_Answer) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
